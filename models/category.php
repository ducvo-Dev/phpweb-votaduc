...
class Category extends Database
{
    ...
    function category_list($args = [])
    {
        ...
        if ($args != null) {
            ...
            //Truy vẫn dữ liệu theo nhiều parentid
            if (array_key_exists('parentid_in', $args)) {
                $strin = implode(',', $args['parentid_in']);
                if ($strWhere == "") {
                    $strWhere .= "parentid IN (" . $strin . ")";
                } else {
                    $strWhere .= " AND parentid IN (" . $strin . ")";
                }
            }
