...
<?php require_once('views/header.php');?>
      ...
      <section class="clearfix content" >
          <div class="container my-3">
            ...
            <h3>Giỏ Hàng</h3>
            <form action="index.php?option=cart&updatecart" method="post" >
                 ...
                 <?php $total_money=0; ?>    
                   <?php foreach($cart_list as $cart_row):?>
                    <tr>
                            ...
                            <td> <input name="qty[]" type="number" value="<?php echo $cart_row['qty'];?>"/> </td>
                            <td> <?php echo number_format ($cart_row['amount']);?> </td>
                            <td class="text-center">
                                <a class="btn btn-sm btn-danger" href="index.php?option=cart&delcart=<?php echo $cart_row['id'];?>" class="text-danger">
                ...
                <tr>
                            <td colspan="3"> 
                                <button name="CAPNHAT" type="submit" class="btn btn-success"> Cập nhật</button>

                                <a  class="btn btn-danger" href="index.php?option=cart&delcart=all">
                                Xóa Giỏ Hàng
                                </a>
